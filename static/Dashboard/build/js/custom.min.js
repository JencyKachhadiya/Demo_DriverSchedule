    ...
    $('[data-toggle="tooltip"]').tooltip(),
      ...
      $(".docs-buttons").on("click", "[data-method]", function () {
        ...
        if (
          ...
          switch (
            ((a = i.cropper(o.method, o.option, o.secondOption)), o.method)
          ) {
            case "scaleX":
            case "scaleY":
  ...
  if (void 0 !== $.fn.daterangepicker) {
    ...
    $("#reportrange_right span").html(
      ...
      $("#reportrange_right").on("apply.daterangepicker", function (e, a) {
        // Filter added for driver trip form
        dateRangeFilter(
          a.startDate.format("MMMM D, YYYY"),
          a.endDate.format("MMMM D, YYYY")
        );
      ...
      (CustomTabs = function (e) {
        $(".tabbed_notifications > div").hide(),
          ...
          $(".notifications a").click(function (e) {
            ...
            var a = $(this),
              t =
                "#" + a.parents(".notifications").data("tabbed_notifications"),
  ...
  if ("undefined" != typeof echarts) {
    ...
    if ($("#echart_scatter").length)
      echarts.init(document.getElementById("echart_scatter"), e).setOption({
        ...
        xAxis: [
          { type: "value", scale: !0, axisLabel: { formatter: "{value} cm" } },
        ],
        yAxis: [
          { type: "value", scale: !0, axisLabel: { formatter: "{value} kg" } },
        ],
        series: [
          {
            name: "Data1",
              ...
              formatter: function (e) {
                return 1 < e.value.length
                  ? e.seriesName +
                      ...
                      e.value[1] +
                      "kg "
                  : e.seriesName + " :<br/>" + e.name + " : " + e.value + "kg ";
              },
            },
            data: [
              [161.2, 51.6],
